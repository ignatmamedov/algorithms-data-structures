...
public class MyHashMapTest {
    ...
    void GivenNonEmptyHashMap_WhenGeneratingGraphViz_ThenReturnCorrectGraph() {
        ...
        hashMap.add("Key2", 2);
        String expectedGraph = "digraph test {\n18: \"Key1=1\";\n19: \"Key2=2\";\n}";
        assertEquals(expectedGraph, hashMap.graphViz("test"), "Expected correct GraphViz representation");
    }
    ...
    void GivenHashMapWithCapacityLimit_WhenAddingElements_ThenCorrectlyExtendCapacity() {
        ...
        limitedCapacityMap.add("Key2", 2); // Should trigger capacity extension
